...
\lstinputlisting[language=R, firstline=37, lastline=56]{PS2_try.R}
	...
	\lstinputlisting[language=R, firstline=58, lastline=62]{PS2_try.R}
	...
	\lstinputlisting[language=R, firstline=64, lastline=70]{PS2_try.R}
	
	\vspace{.2cm}
	\item [(d)] How might the standardized residuals help you interpret the results?  
	
		\lstinputlisting[language=R, firstline=72, lastline=72]{PS2_try.R}
...
\begin{enumerate}
	\item [(a)] State a null and alternative (two-tailed) hypothesis. 
			...
			\lstinputlisting[language=R, firstline=74, lastline=75]{PS2_try.R}
	
	\vspace{.5cm}
	\item [(b)] Run a bivariate regression to test this hypothesis in \texttt{R} (include your code!).
	
	\lstinputlisting[language=R, firstline=77, lastline=92]{PS2_try.R}
	
	\vspace{.2cm}
	\item [(c)] Interpret the coefficient estimate for reservation policy. 
\end{enumerate}

\lstinputlisting[language=R, firstline=94, lastline=94]{PS2_try.R}
\newpage
...
\lstinputlisting[language=R, firstline=96, lastline=106]{PS2_try.R}

\graphicspath{/Users/eedwards/Desktop/GitHub/QTM200Spring2020/problem_sets/PS2/Lifespan_dist}
\includegraphics[width=10cm, height=10cm]{/Users/eedwards/Desktop/GitHub/QTM200Spring2020/problem_sets/PS2/Lifespan_dist}
...
\newpage
	...
	Plot \texttt{lifespan} vs \texttt{thorax}. Does it look like there is a linear relationship? Provide the plot. What is the correlation coefficient between these two variables?
		...
		\lstinputlisting[language=R, firstline=108, lastline=111]{PS2_try.R}
		
		\graphicspath{/Users/eedwards/Desktop/GitHub/QTM200Spring2020/problem_sets/PS2/Thorax_lifespan}
		\includegraphics[width=10cm, height=10cm]{/Users/eedwards/Desktop/GitHub/QTM200Spring2020/problem_sets/PS2/Thorax_lifespan}
		
	\item
	Regress \texttt{lifespan} on \texttt{thorax}.  Interpret the slope of the fitted model.
			\vspace{.2cm}
			
			\lstinputlisting[language=R, firstline=113, lastline=116]{PS2_try.R}
	...
	\lstinputlisting[language=R, firstline=118, lastline=131]{PS2_try.R}
...
\newpage
	...
	\begin{itemize}
		...
		\lstinputlisting[language=R, firstline=133, lastline=140]{PS2_try.R}
		
		\item
		Now, try using the function  \texttt{confint()}  in \texttt{R}.
				
	\end{itemize}
	\lstinputlisting[language=R, firstline=142, lastline=144]{PS2_try.R}
	...
	\item Use the \texttt{predict()} function in \texttt{R} to (1) predict an individual fruitfly's lifespan when \texttt{thorax}=0.8 and (2) the average \texttt{lifespan} of fruitflies when \texttt{thorax}=0.8 by the fitted model. This requires that you compute prediction and confidence intervals. What are the expected values of lifespan? What are the prediction and confidence intervals around the expected values? 
		...
		\lstinputlisting[language=R, firstline=146, lastline=156]{PS2_try.R}
...
\lstinputlisting[language=R, firstline=156, lastline=160]{PS2_try.R}

	\graphicspath{/Users/eedwards/Desktop/GitHub/QTM200Spring2020/problem_sets/PS2/End1}
\includegraphics[width=10cm, height=10cm]{/Users/eedwards/Desktop/GitHub/QTM200Spring2020/problem_sets/PS2/End1}
