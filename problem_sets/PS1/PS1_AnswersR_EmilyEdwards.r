...
plot(expenditure$X1,expenditure$Y, main = "Relationship Between Per Capita Personal Income and Per Capita Expenditure on Public Education", xlab = "Per Capita Personal Income", ylab = "Per Capita Expenditure on Public Education", col= c(expenditure$Region, pch=c(expenditure$Region)))
# Legend: Northeast = black, North Central = red, South = green, West = blue
# SOLUTION: The correlation between per capita personal income and per capita expenditure on public education is strongest for the South and the West. There is weak positive correlation for Northeast, and no correlation for North Central.
